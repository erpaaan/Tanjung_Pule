        ...
        <div className="grid grid-cols-1 gap-6 max-w-4xl">
          {requests.length === 0 ? (
            ...
            requests.map((item: any) => (
              <div key={item.id} className="p-8 bg-white rounded-[2.5rem] shadow-sm border border-slate-100 flex justify-between items-center transition-all hover:shadow-md">
                <div className="space-y-2">
                  ...
                  <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">{item.jenis_surat} • NIK: {item.nik}</p>
